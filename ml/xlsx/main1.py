...
def make_predictions(product_data, future_days=7):
    ...
    for i in range(future_days):
        ...
        product_data = product_data.append({'Scaled Demand': scaled_prediction,
...
def check_reorder(product_data, product_name):
    ...
    print(f"Last Visible Stock: {last_visible_stock}, Last Inventory Stock: {last_inventory_stock}, Reorder Threshold: {reorder_thresh}")
    if last_visible_stock < reorder_thresh and last_inventory_stock < reorder_thresh:
